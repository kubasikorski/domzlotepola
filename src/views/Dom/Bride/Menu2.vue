        ...
        <div class="container relative z-10 mt-16 lg:mt-32 food">
            <div class="flex flex-col items-center">
                <vue-aos animation-class="fadeInLeft animated">
                    <h3 class="font-bebas text-center text-6xl leading-none">Menu weselne<br>od 278 zł / osoba</h3>
                </vue-aos>
...
<script>
    ...
    export default {
        metaInfo: {
            ...
            titleTemplate: '%s - Oferta dla pary młodej - Menu weselne od 278 zł / osoba',
            htmlAttrs: {
                lang: 'pl',
                amp: true
            }
