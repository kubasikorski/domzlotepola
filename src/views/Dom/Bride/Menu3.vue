        ...
        <div class="container relative z-10 mt-16 lg:mt-32 food">
            <div class="flex flex-col items-center">
                <vue-aos animation-class="fadeInLeft animated">
                    <h3 class="font-bebas text-center text-6xl leading-none">Menu weselne<br>od 188 zł / osoba</h3>
                </vue-aos>
            ...
            <div class="flex justify-center text-center">
                <div class="lg:w-1/2">
                    ...
                    <div class="mt-16 m-4 pt-4 border-t border-primary-lightest">
                        <p class="leading-relaxed">Cena <span class="font-semibold">od 188 zł</span> za osobę dorosłą
                ...
                <div class="lg:w-1/2 mt-6">
                    ...
                    <div class="mt-16 m-4 pt-4 border-t border-primary-lightest">
                        <p class="leading-relaxed italic">
                            wariant 1 – cena 12,50 zł / od osoby  powyżej 40 osób<br>
                            wariant 1 + wariant 2 – cena 26 zł / od osoby  powyżej 40 osób<br>
                            wariant 1 + wariant 2 + wariant 3 – cena 28 zł / od osoby  powyżej 40 osób<br>
                        </p>
                    </div>
                </div>
            </div>
        ...
        <div class="container relative z-10 mt-16 lg:mt-32 food">
            ...
            <div class="flex justify-center text-center">
                <div class="lg:w-1/2 mt-6">
                    ...
                    <div class="mt-16 m-4 pt-4 border-t border-primary-lightest">
                        <p class=" leading-relaxed italic">Cena 17,00zł od osoby / 0,5l na osobę<br>(cena menu napoje
            ...
            <div class="text px-16 lg:px-24 flex justify-center text-center">
                <ul class="text-left">
                    ...
                    <li>Umożliwiamy dostarczenie dodatkowych własnych ciast i tortów bez dodatkowych opłat za okazaniem dowodu zakupu oraz dostawy bezpośrednio przez cukiernię.
                    </li>
...
<script>
    ...
    export default {
        metaInfo: {
            ...
            titleTemplate: '%s - Oferta dla pary młodej - Menu weselne od 188 zł / osoba',
            htmlAttrs: {
                lang: 'pl',
                amp: true
            }
