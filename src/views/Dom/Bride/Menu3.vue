        ...
        <div class="lg:w-1/2 mt-6">
          ...
          <div class="mt-16 m-4 pt-4 border-t border-primary-lightest">
            <p class="leading-relaxed italic">
              wariant 1 – cena {{ prices.variantPrice.v1 }} zł / od osoby powyżej 40 osób<br>
              wariant 1 + wariant 2 – cena {{ prices.variantPrice.v2 }} zł / od osoby powyżej 40 osób<br>
              wariant 1 + wariant 2 + wariant 3 – cena {{ prices.variantPrice.v3 }} zł / od osoby powyżej 40 osób<br>
            </p>
          </div>
        </div>
      </div>
