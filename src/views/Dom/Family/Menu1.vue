    ...
    <div>
        <div class="container relative z-10 mt-16 lg:mt-32 food">
            <div class="flex flex-col items-center">
                <vue-aos animation-class="fadeInLeft animated">
                    <h3 class="font-bebas text-center text-6xl leading-none">Menu<br>od 89 zł / osoba</h3>
                </vue-aos>
            ...
            <div class="flex justify-center text-center">
                <div class="lg:w-1/2">
                    ...
                    <div class="mt-16 m-4 pt-4 border-t border-primary-lightest">
                        <p class="leading-relaxed">Cena <span class="font-semibold">od 89 zł</span> za osobę dorosłą
                            <br>(cena zależna od ilości osób i czasu trwania przyjęcia)<br>Torty okolicznościowe i dodatkowe desery – indywidualna wycena
                            <br><br>
                ...
                <div class="lg:w-1/2 mt-6">
                    ...
                    <div class="mt-16 m-4 pt-4 border-t border-primary-lightest">
                        <p class="leading-relaxed italic">
                            wariant 1 – cena 12,5 zł / od osoby  powyżej 20 osób<br>
                            wariant 1 + wariant 2 – cena 26 zł / od osoby  powyżej 20 osób<br>
                            wariant 1 + wariant 2 + wariant 3 – cena 28 zł / od osoby  powyżej 20 osób<br>
                        </p>
                    </div>
                </div>
            </div>
        ...
        <div class="container relative z-10 mt-16 lg:mt-32 food">
            <div class="flex flex-col items-center">
                ...
                <h4 class="font-bebas text-center text-4xl leading-none">podane w dzbankach na stole biesiadnym lub bufecie</h4>
                <img src="@/assets/images/footer-leaf.png" alt="">
            </div>
            <div class="flex justify-center text-center">
                <div class="lg:w-1/2 mt-6">
            ...
            <div class="text px-16 lg:px-24 flex justify-center text-center">
                <ul class="text-left">
                    ...
                    <li>Umożliwiamy dostarczenie dodatkowych własnych ciast i tortów bez dodatkowych opłat za okazaniem dowodu zakupu oraz dostawy bezpośrednio przez cukiernię.</li>
                    <li>Atrakcyjne ceny dla uczestników przyjęć okolicznościowych na pobyt w pokojach gościnnych Domu Złote Pola.</li>
                </ul>
            </div>
